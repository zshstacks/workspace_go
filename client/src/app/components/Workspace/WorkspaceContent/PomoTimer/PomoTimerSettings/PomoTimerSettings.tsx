...
const PomoTimerSettings = React.memo<PomoTimerSettingsProps>(
  ({ setIsHideCount, ishideCount, setVolume, volume, setTimerSound }) => {
...
PomoTimerSettings.displayName = "PomoTimerSettings";
