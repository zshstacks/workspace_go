...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        bgMain:
          'url("https://images.unsplash.com/photo-1534088568595-a066f410bcda?q=80&w=1951&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        bgAuth:
